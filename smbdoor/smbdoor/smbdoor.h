...
typedef NTSTATUS(NTAPI *SRVNETREGISTERCLIENT)(_In_ PSMBDOOR_SRVNET_REGISTRATION ServerRegistration, _Out_ PHANDLE Handle);
typedef VOID(NTAPI *SRVNETSTARTCLIENT)(_In_ HANDLE Handle);
typedef VOID(NTAPI *SRVNETSTOPCLIENT)(_In_ HANDLE Handle);
typedef VOID(NTAPI *SRVNETDEREGISTERCLIENT)(_In_ HANDLE Handle);
